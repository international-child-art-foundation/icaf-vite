...
The .htaccess file generated by our GitHub Action workflow has to exclude those directory names for them to be accessible from the frontend without reaching a 404 page. Current server-root asset directories include /ChildArt, /assets, /data, /documents, /gallery-arts, and /large-media.
