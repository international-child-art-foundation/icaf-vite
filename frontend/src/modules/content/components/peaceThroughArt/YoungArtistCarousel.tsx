...
import { YoungArtistArtworks } from '@/modules/content/data/peaceThroughArt/PeaceThroughArtData';

import colorfulBannerBackground from '@/modules/content/assets/peaceThroughArt/colorfulBannerBackground.svg';
