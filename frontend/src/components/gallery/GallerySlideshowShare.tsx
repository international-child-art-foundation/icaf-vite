...
const FacebookGlyph = () => (
  <svg viewBox="0 0 32 32" width="28" height="28" fill="#262626" aria-hidden>
...
const WhatsappGlyph = () => (
  <svg viewBox="0 0 24 24" width="17" height="17" fill="#262626" aria-hidden>
...
const XGlyph = () => (
  <svg viewBox="0 0 32 32" width="23" height="23" fill="#262626" aria-hidden>
...
const LinkedInGlyph = () => (
  <svg viewBox="0 0 32 32" width="26" height="26" fill="#262626" aria-hidden>
...
const BTN =
  'flex h-9 w-9 items-center justify-center text-white hover:bg-black/5 transition-colors active:scale-95 w-full';
