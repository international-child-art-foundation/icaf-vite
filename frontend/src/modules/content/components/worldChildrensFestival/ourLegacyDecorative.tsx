import { WhiteBannerMobile } from '@/modules/content/assets/worldChildrensFestival/whiteBannerMobile';
import { BlueBannerMobile } from '@/modules/content/assets/worldChildrensFestival/blueBannerMobile';
import { WhiteBanner } from '@/modules/content/assets/worldChildrensFestival/whiteBanner';
import { BlueBanner } from '@/modules/content/assets/worldChildrensFestival/blueBanner';
import Graphic from '@/modules/content/assets/about/more/Group 514888.svg';
import { AboutGraphic1 } from '@/modules/content/assets/about/AboutGraphic1';
import { AboutGraphic2 } from '@/modules/content/assets/about/AboutGraphic2';
import congress from '@/modules/content/assets/worldChildrensFestival/congress.webp';
import YellowConfetti from '@/modules/content/assets/worldChildrensFestival/yellowConfetti.svg';
  ...
  return (
    <div>
      <div className="md:mt-76 relative z-0 mb-32 mt-44 w-full sm:mt-72">
        ...
        <div className="absolute bottom-0 left-0 z-30 hidden w-full overflow-hidden md:-bottom-[58rem] md:block lg:-bottom-[60rem] xl:-bottom-[58rem] 2xl:-bottom-[59rem]">
        ...
        <BlueBanner className="absolute left-0 top-0 z-10 hidden h-[700px] w-full lg:block lg:h-[1000px] xl:h-[1000px] 2xl:h-[1000px]" />
        ...
        <div className="absolute -bottom-[60rem] right-6 z-50 md:-bottom-[70rem] md:right-10 lg:-bottom-[65rem] lg:right-24 xl:-bottom-[68rem]">
