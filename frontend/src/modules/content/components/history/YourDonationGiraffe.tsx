...
import DonateButtonPure from '../../../../shared/components/ui/donateButtonPure';
import giraffeGroup from '@/modules/content/assets/history/GiraffeGroup.webp';
import { Link } from 'react-router-dom';

export const YourDonationGiraffe = () => {
  return (
    <div className="content-w m-pad">
      <div className="relative mb-32 flex h-[332px] w-full flex-col justify-center overflow-hidden overflow-visible rounded-2xl bg-[#E0E8F8] px-6 text-center md:h-[300px] md:px-12 md:text-left lg:h-[320px] xl:h-[340px] 2xl:h-[400px]">
