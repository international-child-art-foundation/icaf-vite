import ClimateFestivalImg from '@/modules/content/assets/volunteer/volunteerGroup.webp';
    ...
    <div className="content-w m-pad flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-8 lg:grid lg:grid-cols-2 lg:items-center">
        <div className="flex h-full flex-col lg:pr-8">
          <div className="flex flex-1 flex-col justify-center gap-4 text-lg">
            ...
            <p>
              ...
              expertise yet, but wants to get involved and make a difference, we
              would love to receive your application. About{' '}
        ...
        <div className={rightImageWrapperClasses}>
          <img src={ClimateFestivalImg} className={rightImageClasses} alt="" />
        </div>
      </div>
    </div>
  );
