...
import CarouselArrowsDots from '@/modules/content/components/shared/CarouselArrowsDots';
import { pastFestivalsData } from '@/modules/content/data/wcf/pastFestivals';
