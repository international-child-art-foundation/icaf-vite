...
import ClimateChangeHeaderImg from '@/modules/content/assets/climateChange/climateChangeHeader.webp';
...
export const ClimateChangeHeader = () => {
  ...
  return (
    <div className="site-w grid grid-cols-1 grid-rows-1">
      <div className="hero-w font-montserrat z-10 col-start-1 row-start-1 mt-24 flex flex-col gap-2 pt-6 text-3xl font-extrabold text-white sm:gap-4 sm:pt-10 md:mt-8 md:text-4xl lg:mt-24 lg:text-6xl">
