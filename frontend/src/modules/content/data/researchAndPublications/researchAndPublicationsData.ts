import { IResearchAndPublicationsItem } from '@/modules/content/types/ResearchAndPublicationsTypes';
import theCreativityRevolutionImg from '@/modules/content/assets/researchAndPublications/the_creativity_revolution.webp';
import creativeEmpathsImg from '@/modules/content/assets/researchAndPublications/dynamische_psychiatrie.webp';
import steamJournalImg from '@/modules/content/assets/researchAndPublications/steam_journal.webp';
import theLancetImg from '@/modules/content/assets/researchAndPublications/the_lancet.webp';
import theGreatCulturalAwakeningImg from '@/modules/content/assets/researchAndPublications/the_great_cultural_awakening.webp';
import disruptScienceImg from '@/modules/content/assets/researchAndPublications/disrupt_science.webp';
