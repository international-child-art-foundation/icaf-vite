...
export const Page404 = () => {
  ...
  return (
    <div className="relative flex h-full w-full flex-1 flex-col items-center">
      <div className="grid-cols-auto relative mx-auto my-auto grid max-w-screen-2xl grid-rows-[1fr_1fr] items-center gap-12 overflow-hidden px-8 py-12 md:grid-cols-[1fr_0.75fr] md:grid-rows-[1fr] md:px-12 lg:px-16 xl:px-20">
