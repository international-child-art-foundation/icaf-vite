...
import foundingImg from '@/modules/content/assets/history/ICAFFounding.webp';
import MagazineCover from '@/modules/content/assets/history/MagazineCover.webp';
import DCMayorImg from '@/modules/content/assets/history/DCMayor.webp';
import { HistoryMomentCard } from './HistoryMomentCard';
import { TMomentsCarouselData } from '@/modules/content/types/History';
