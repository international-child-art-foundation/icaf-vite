import {
  IGoalCard,
  IResourceLink,
} from '@/modules/content/types/HealingArtsTypes';
import { LeafIcon } from '@/shared/assets/icons/LeafIcon';
...
export const ResourceLinks: IResourceLink[] = [
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/thanksgiving_in_palestine.pdf',
  },
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/Pakistan - Earthquake Relief Efforts.pdf',
  },
  {
  ...
  },
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/Expanding Awareness of Mental Health in Childhood and Adolescence.pdf',
  },
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/Destruction, Reconstruction & Prevention.pdf',
  },
  {
  ...
  },
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/Sichuan Healing Arts.pdf',
  },
  {
    ...
    behavior: 'link',
    fileType: 'PDF',
    href: 'https://docs.icaf.org/Haiti Healing Arts - Guidelines_ICAF.pdf',
  },
];
