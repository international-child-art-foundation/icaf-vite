...
import { IAccordionCard } from '@/modules/content/types/AccordionCardTypes';
...
const AccordionDropdowns = ({ data }: AccordionDropdownProps) => {
  ...
  return (
    <div>
      <div className="mx-auto grid auto-rows-min grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-3">
        {data.map((itemData) => {
