...
import { childArtExhibition } from '@/modules/content/data/donate/childArtExhibitionData';
import DonationUsageOrgCards from '@/modules/content/components/donate/DonationUsageOrgCards';
import QuoteBanner from '@/modules/content/components/donate/QuoteBanner';
import IntroBanner from '@/modules/content/components/donate/IntroBanner';
...
const donateMetadata = {
  title: 'Donate | ICAF',
  description:
    'Invest in a brighter future for children by sending ICAF a donation.',
  path: '/donate',
};
  ...
  return (
    <>
      ...
      <div className="content-gap overflow-hidden">
        ...
        <div className="breakout-w m-pad text-center">
          <h2 className="mb-4 text-3xl font-bold text-black md:text-4xl">
            Art by the children we serve
          </h2>
          <p className="mb-6 text-base text-black">
            Every piece of art here tells a story of hope and resilience. Here's
            a glimpse of the talent you're supporting.
          </p>
