import { IBoardMember } from '@/modules/content/types/BoardMemberTypes';

export const boardMembers: IBoardMember[] = [
  {
    name: "Charlie O'Shields",
    title: 'Founder, World Watercolor Month',
    link: 'https://www.linkedin.com/in/storywize/',
  },
  {
    name: 'Dr. Danica Radovanovic',
    title: 'Digital literacy and Child Safety Online',
    link: 'https://www.linkedin.com/in/danicar/',
  },
  {
    name: 'Katty Guerami',
  ...
  {
    name: 'Dr. Ngozi Rosemary Akande',
    title: 'Artist and Female Artist Association',
    link: 'https://ngoziakandearts.com/',
  },
  {
  ...
  {
    name: 'Dr. Aurora Sidney-Ando',
    title: 'Counseling Psychologist',
    link: '', // No link provided for Aurora
  },
  {
