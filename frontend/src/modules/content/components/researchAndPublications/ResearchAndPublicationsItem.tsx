...
export const ResearchAndPublicationsItem = ({
  ...
  return (
    <div className="bg-primary-muted/15 border-primary-muted/15 hover:bg-primary-muted/5 card-pad group rounded-xl border-2 p-4 transition-all sm:p-8">
      <div className="grid h-auto w-full grid-cols-2 grid-rows-[auto_1fr] gap-x-6 overflow-hidden md:h-[400px] xl:h-[500px]">
