import ChildArtAishling from '@/modules/content/assets/donate/ChildArt-Aishling.png';
import ChildArtCarsonBeyl from '@/modules/content/assets/donate/ChildArt-Carson Beyl.png';
import ChildArtJonathan from '@/modules/content/assets/donate/ChildArt-Jonathan.png';
import ChildArtKristina from '@/modules/content/assets/donate/ChildArt-Kristina.png';
import ChildArtMalta from '@/modules/content/assets/donate/ChildArt-Malta.png';
import ChildArtVirginia from '@/modules/content/assets/donate/ChildArt-Virginia(EstherKim).png';
