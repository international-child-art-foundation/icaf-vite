...
export const ClimateChangeHeader = () => {
  ...
  return (
    <div className="site-w grid grid-cols-1 grid-rows-1">
      <div className="font-montserrat z-10 col-start-1 row-start-1 mt-24 flex flex-col gap-2 p-6 text-3xl font-extrabold text-white sm:gap-4 sm:p-10 sm:px-8 md:mt-8 md:px-12 md:text-4xl lg:mt-20 lg:px-16 lg:text-6xl xl:px-20">
