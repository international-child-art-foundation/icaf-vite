import congress from '@/modules/content/assets/worldChildrensAward/congress-img.webp';
import firework from '@/modules/content/assets/worldChildrensAward/firework-small.svg';
