...
import { fetchArtworkReviewPage, parseReviewParams } from "../shared/contributorUtils";
...
export const handler = async (
  ...
  try {
    ...
    const page = await fetchArtworkReviewPage("rejected", params.limit, params.lastKey);
    ...
    console.error("Error fetching rejected artworks:", error);
