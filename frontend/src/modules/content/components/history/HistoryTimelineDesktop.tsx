...
import { icafTimelineData } from '@/modules/content/data/history/icafTimelineData';
import threeLines from '@/modules/content/assets/history/ThreeLines.svg';
import redBlueFirework from '@/shared/assets/images/RedBlueFirework.svg';
import pinkPuddle from '@/shared/assets/svg-arg/PuddleBackground.svg';
import bluePuddle from '@/shared/assets/svg-arg/PuddleBackgroundLarge.svg';
import yellowPuddle from '@/shared/assets/svg-arg/PuddleBackgroundLargest.svg';
import smallYellowPuddle from '@/shared/assets/svg-arg/PuddleBackgroundSmall.svg';
