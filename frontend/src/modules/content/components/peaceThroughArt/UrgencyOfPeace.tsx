import usImg from '@/modules/content/assets/peaceThroughArt/united-states-congress-background-flat-style 1.webp';
import blueFirework from '@/modules/content/assets/peaceThroughArt/blueFirework.svg';
