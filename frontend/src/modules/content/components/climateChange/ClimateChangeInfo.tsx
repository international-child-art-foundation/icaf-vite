...
import muralTwo from '@/modules/content/assets/climateChange/AO4 Nigeria. Judith Yahaya 12.webp';
import muralThree from '@/modules/content/assets/climateChange/AO5 USA. Alina Ponomarenko 11. “The Camping Site”.webp';
import muralFour from '@/modules/content/assets/climateChange/Peru (Carla Guadalupe Gonzalez De La Cruz, 8).webp';
import muralFive from '@/modules/content/assets/climateChange/Austria (Samara Claudia Bittermann, 10).webp';
