import { IActivityItem } from '@/modules/content/types/HomeActivities';
...
export const ActivityItem = ({ item, expanded, toggle }: ActivityItemProps) => {
  const commonProps = {
    className:
      'grid cursor-pointer grid-cols-1 grid-rows-1 overflow-hidden rounded-[40px]',
    ...
    <>
      <div className="card-pad relative z-10 col-start-1 row-start-1 my-auto h-full p-4 text-white xl:py-9">
        <div className="grid-col grid h-full place-content-center place-items-center items-center gap-4">
          ...
          <p
            className={`font-open-sans duration-400 grid transition-all ${
              expanded
