import Money from '@/modules/content/assets/donate/Money.svg';
import Earth from '@/modules/content/assets/donate/Earth.svg';
import Donator from '@/modules/content/assets/donate/Donator.svg';
