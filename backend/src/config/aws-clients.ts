...
export const CONTACT_NOTIFICATION_EMAILS = parseEmailList(process.env.CONTACT_NOTIFICATION_EMAILS);
...
export const MAGAZINES_CLOUDFRONT_DISTRIBUTION_ID = process.env.MAGAZINES_CLOUDFRONT_DISTRIBUTION_ID;
