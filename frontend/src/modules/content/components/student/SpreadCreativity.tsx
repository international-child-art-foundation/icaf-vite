import blueBackground from '@/modules/content/assets/student/blueBackground.svg';
import blueBackgroundSmall from '@/modules/content/assets/student/blueBackgroundSmall.svg';
