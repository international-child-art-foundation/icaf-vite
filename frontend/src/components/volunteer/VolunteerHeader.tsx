...
export const VolunteerHeader = () => {
  ...
  return (
    <div className="site-w grid grid-cols-1 grid-rows-1">
      <div className="font-montserrat z-10 col-start-1 row-start-1 flex flex-col gap-2 p-6 text-3xl font-extrabold text-white sm:gap-4 sm:p-10 sm:px-8 md:mt-8 md:px-12 md:text-4xl lg:mt-28 lg:px-16 lg:text-6xl xl:px-20">
        ...
        <p className="font-openSans text-xl font-normal text-white lg:max-w-[50%] xl:max-w-[38%]">
          ICAF's programs depend on the action of teams of dedicated volunteers
          keen on making a difference.
        </p>
        <p className="font-openSans text-xl font-normal text-white lg:max-w-[50%] xl:max-w-[38%]">
          If you or someone you know has been positively impacted by ICAF, we
          warmly invite you to apply to join our growing volunteer family.
        </p>
      </div>
