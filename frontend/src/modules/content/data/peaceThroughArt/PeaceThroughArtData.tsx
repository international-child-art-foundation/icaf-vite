...
} from '@/modules/content/types/PeaceThroughArtTypes';
import artAdibHayat from '@/modules/content/assets/peaceThroughArt/Adib Hayat, 11, Lebanon.webp';
import artAmalAlHajj from '@/modules/content/assets/peaceThroughArt/Amal Al Hajj (age 9) Yemen 1.webp';
import artAmirReza from '@/modules/content/assets/peaceThroughArt/Amir Reza,9, Iran.webp';
import artAnnaCarolinaIsrael from '@/modules/content/assets/peaceThroughArt/Anna Carolina Israel, 12, Brazil.webp';
import artDifeiLi from '@/modules/content/assets/peaceThroughArt/Difei Li, 10, New Jersey.webp';
import artEllaGordanLatty from '@/modules/content/assets/peaceThroughArt/Ella Gordan-Latty, 12, New Zealand.webp';
import artFadelAdib from '@/modules/content/assets/peaceThroughArt/Fadel Adib 9, Lebanon.webp';
import artNathaniaCarolineCandra from '@/modules/content/assets/peaceThroughArt/Nathania Caroline Candra, 8, Indonesia.webp';
import artNehaSiddiqui from '@/modules/content/assets/peaceThroughArt/Neha Siddiqui, 11, Pakistan.webp';
import artRoxanaChisalita from '@/modules/content/assets/peaceThroughArt/Roxana Chisalita, 11, Romania.webp';
import artMiryamBaadsa from '@/modules/content/assets/peaceThroughArt/Miryam Baadasa, 11, Palestine.webp';
import artTessaCrisman from '@/modules/content/assets/peaceThroughArt/Tessa Rae Crisman, 11, Colorado.webp';
