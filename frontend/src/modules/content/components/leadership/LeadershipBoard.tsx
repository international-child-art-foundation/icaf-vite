import { boardMembers } from '@/modules/content/data/leadership/BoardMembers';
import { BoardMembers } from './BoardMembers';

export const LeadershipBoard = () => {
  return (
    <div className="content-w m-pad flex flex-col items-center gap-12 text-center">
      <div className="flex flex-col items-center gap-8">
        <h2 className="font-montserrat text-3xl font-extrabold lg:text-[40px]">
          Board Members
        </h2>
        <p className="max-w-[700px] text-[24px] leading-7">
