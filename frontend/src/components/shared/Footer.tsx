...
function Footer() {
  ...
  return (
    <footer className="2xl:min:h-[310px] bg-primary relative z-20 mx-auto min-h-[670px] w-full font-sans lg:min-h-[480px] xl:min-h-[310px]">
      <div className="mx-5% lg:max-w-screen-3xl mx-auto flex flex-wrap justify-between gap-y-10 px-8 pb-10 pt-14 md:px-12 lg:gap-y-16 lg:px-16 lg:py-10 xl:grid xl:auto-rows-min xl:grid-cols-12 xl:gap-x-8 xl:gap-y-16 xl:px-20">
