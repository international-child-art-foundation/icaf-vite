...
import {
  ...
  WHOLogo,
  XRSILogo,
} from '@/modules/content/assets/partners';
import '@/index.css';
import {
  Carousel,
  CarouselContent,
...
import { IPartners } from '@/modules/content/types/partners';
import { PartnerItem } from '@/modules/content/components/partners/PartnerItem';
import { useState, useEffect } from 'react';
import { CarouselSharedContent } from '@/modules/content/components/partners/CarouselSharedContent';
  ...
  return (
    <>
      ...
      <div className="content-gap">
        ...
        <section className="content-w m-pad flex flex-col gap-8 lg:gap-12">
          ...
          <p className="font-sans text-lg leading-relaxed">
            ...
            across nearly 100 countries to inspire and empower children through
            art and creativity. In the United States, we work closely with
            schools and after-school programs to reach young minds directly. Our
            partnerships play a vital role in our mission to nurture creativity
            and empathy in children worldwide through the powers of art (and
            sports).
          </p>
