import { ContentCarouselData } from '@/modules/content/types/ImpactPageTypes';
import palette from '@/modules/content/assets/impact/palette.svg';
import camera from '@/modules/content/assets/impact/camera.svg';
import award_star from '@/modules/content/assets/impact/award_star.svg';
import painting from '@/modules/content/assets/impact/Painting.webp';
import awards from '@/modules/content/assets/impact/Awards.webp';
import childrenFromMalaysia from '@/modules/content/assets/impact/Children from Malaysia.webp';
