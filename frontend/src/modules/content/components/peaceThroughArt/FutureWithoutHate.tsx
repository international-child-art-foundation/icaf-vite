import bannerBackground from '@/modules/content/assets/peaceThroughArt/bannerBackground.svg';
import threeLines from '@/modules/content/assets/peaceThroughArt/threeLines.svg';
import { PTACard } from './PTACard';
import { PTACardData } from '@/modules/content/data/peaceThroughArt/PeaceThroughArtData';
