import { globeKids, soccer } from '@/assets/shared/images/home/circle-images';

const WhatWeDo = () => {
  return (
    <div className="flex flex-col items-center gap-6 p-6 py-24 lg:gap-10 lg:p-10 lg:py-[130px]">
      ...
      <p className="mt-4 font-montserrat text-2xl font-bold text-black lg:mt-5 lg:text-center">
